...
Income({super.key});
  ...
  // Receive incomeManager as a parameter
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton2<String>(
                          ...
                          items: items
                              ...
                              .toList(),
                          value: gh.incomecategory,
                          onChanged: (value) {
                            gh.incomeCategory(value);
                          },
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton2<String>(
                          ...
                          items: wallet
                              ...
                              .toList(),
                          value: gh.incomewallet,
                          onChanged: (String? value) {
                           gh.incomeWallet(value);
                          },
                          buttonStyleData: ButtonStyleData(),
                          menuItemStyleData: MenuItemStyleData(),
                          iconStyleData: IconStyleData(
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        gh.onAdd(int.parse(num.text));
                        int ff = int.parse(num.text);

                        //final name =descriptiontext.text;
                        adi(DataModel(description: descriptiontext.text,category:gh.incomecategory??'' ,money:ff,wallet: gh.incomewallet??'',displayMoney: true
                          ));
